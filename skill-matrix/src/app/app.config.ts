...
import * as notificationsEffects from './core/store/notifications/notifications.effects';
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    provideStore(
      { session: sessionReducer, team: teamReducer, notifications: notificationsReducer },
      { metaReducers }
    ),
    provideEffects(sessionEffects, teamEffects, notificationsEffects),
